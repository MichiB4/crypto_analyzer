# crypto_analyzer
A simple Python application that fetches real-time cryptocurrency prices and creates interactive candlestick charts for technical analysis. 
For the HSG course "Programming with Advanced Computer Languages".
